...
> Rationale records: structure v2.0 (2026-09-15) — three working lessons synced from the owner's working notes: fix the producer not the copy (working discipline), one bounded confirmation round after a cap-triage fold, and cross-vendor reviewers overlapping on mechanical defects and complementing on interpretive ones (independently converged findings near-certain, disagreement diagnostic); structure v1.8–1.9 (2026-08-11) — per-feature code review upgraded to the review-before-load-bearing model, ported from a production project's constitution rule 15 (independence, semantic rigor ladder, gate-specific verdicts, recorded reviews) during a project scaffold; v1.9 same day adds the owner's 2026-08-08 bounded-adversarial-rounds rulings (3-round cap + triage table, fold-surface deferral, fold-the-class sweeps) synced from that project; 2026-07-28 — review-convergence discipline adopted, from a review-process assessment; 2026-07-19 — the prior version's reasoning adopted.
...
- **No cloud-synced folders for repos** (decided 2026-07-04): projects live in plain local folders with private GitHub remotes. Cloud sync corrupts git repositories. Pre-existing Drive projects are legacy; see the legacy section of `PROJECTS.md`.

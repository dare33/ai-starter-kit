...
_(One-liners only: any moment where the governance itself slowed the task or misled —
a template section, a playbook rule, a protocol step. Closeout sweeps these into suite
edits. This is how the tool improves without anyone maintaining it.)_
